...
func (uu *URLUpdate) SetShortenedURL(s string) *URLUpdate {
	uu.mutation.SetShortenedURL(s)
	return uu
}

// SetNillableShortenedURL sets the "shortened_url" field if the given value is not nil.
func (uu *URLUpdate) SetNillableShortenedURL(s *string) *URLUpdate {
	if s != nil {
		uu.SetShortenedURL(*s)
	}
	return uu
}
...
func (uu *URLUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.ShortenedURL(); ok {
		_spec.SetField(url.FieldShortenedURL, field.TypeString, value)
	}
...
// SetShortenedURL sets the "shortened_url" field.
func (uuo *URLUpdateOne) SetShortenedURL(s string) *URLUpdateOne {
	uuo.mutation.SetShortenedURL(s)
	return uuo
}

// SetNillableShortenedURL sets the "shortened_url" field if the given value is not nil.
func (uuo *URLUpdateOne) SetNillableShortenedURL(s *string) *URLUpdateOne {
	if s != nil {
		uuo.SetShortenedURL(*s)
	}
	return uuo
}
...
func (uuo *URLUpdateOne) sqlSave(ctx context.Context) (_node *Url, err error) {
	...
	if value, ok := uuo.mutation.ShortenedURL(); ok {
		_spec.SetField(url.FieldShortenedURL, field.TypeString, value)
	}
